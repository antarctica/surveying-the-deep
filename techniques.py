"""
This script generates Figure 1 from Surveying the Deep: A Review of Computer Vision in the Benthos (Trotter et al. 2025).
...
def parse_args():
    ...
    parser.add_argument('input', type=str, help='Path to the input CSV file containing the publication data.')
    parser.add_argument('output', type=str, help='Path for saving the output image file.')

    parser.add_argument('--filename', type=str, default='techniques', help='Name of the output image file. Default is "techniques".')
    ...
    parser.add_argument('--title', type=str, default=None, help='Title of the plot. Default is None.')
    parser.add_argument('--fig-size', type=int, nargs=2, default=(10,5), help='Size of the output image file in inches. Default is (10,5).')
    parser.add_argument('--xlabel', type=str, default='Year', help='Label for the x-axis. Default is "Year".')
    parser.add_argument('--ylabel', type=str, default='Number of Papers', help='Label for the y-axis. Default is "Number of Papers".')
    parser.add_argument('--no-show-legend', action='store_true', help='Do not show the legend on the plot. Default is False.')
    parser.add_argument('--legend-title', type=str, default='Techniques', help='Title of the legend. Default is "Techniques".')
    parser.add_argument('--no-print-stats', action='store_true', help='Do not print statistics about the techniques used in the publications. Default is False.')
    parser.add_argument('--after-year-only', type=int, default=None, help='Only show statistics after this year. Default is None.')
...
def format_df(df):
    ...
    Returns:
        df_techs (pandas.core.frame.DataFrame): A pandas dataframe containing the publication data with the techniques formatted.
    """
...
def generate_stacked_barchart(df, args):
    ...
    Args:
        df (pandas.core.frame.DataFrame): A pandas dataframe containing the publication data with the techniques formatted.
        args (argparse.Namespace): An argparse namespace containing the parsed arguments.
    """
